...
class TestLogin:
    ...
    #     allure.attach("", "判断是否弹出引导页")
    #     sleep(1)
    #     result = self.base_webaction.is_displayed(self.login_page.smrz_jump_over)
    #
    #     if hover == "0":
    #         allure.attach("", "点击" + description)
    #         self.login_page.click_css_xapth(label, element)
    ...
    #             assert False
    #
    #     elif result == True and hover == "1":
    #         allure.attach("", "点击跳过引导")
    #         self.base_webaction.click_element(self.login_page.smrz_jump_over)
    #         # 获取当前句柄
    #         current = self.base_webaction.current_handle()
    #         allure.attach("", "点击" + description)
    #         self.login_page.click_css_xapth(label, element)
